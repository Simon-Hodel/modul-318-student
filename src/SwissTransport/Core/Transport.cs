namespace SwissTransport.Core
{
  ...
  public class Transport : ITransport, IDisposable
  {
    ...
    public Connections GetConnections(string fromStation, string toStation, DateTime dateValue, DateTime timeValue, bool isArrivalTime)
    {
      ...
      var uri = new Uri($"{WebApiHost}connections?from={fromStation}&to={toStation}&limit=16&date={dateValue}&time{timeValue}&isArrivalTime{isArrivalTime}");
